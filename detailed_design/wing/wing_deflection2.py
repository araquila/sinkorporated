...
#        Lift.append(1.15*1/2*rho_cruise*Area[i]*cl[i]*V_cruise**2)
#        Drag.append(1.15*1/2*rho_cruise*Area[i]*cd[i]*V_cruise**2)
#        AeroMoment.append(1.15*1/2*rho_cruise*Area[i]*cm_c4[i]*V_cruise**2*Chord[i])
#        

...
#centroid_root = 2*((t_sheet + (height_wingbox(0)-2*t_sheet)/2)*(height_wingbox(0)-2*t_sheet)*t_sheet + (3*t_sheet/2 + height_wingbox(0)))/(2*(height_wingbox(0)-2*t_sheet)*t_sheet + 2*width_wingbox(0)*t_sheet)
print(height_wingbox(0)/2)
print(centroid_root)

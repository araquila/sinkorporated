...
for i in range(50):
    ...
    M_empty_jet, geometrylistfuselage, geometrylistwings, geometrylistvtail, x_cg , Fus_len= iterempty(MTOW_jet, OEW_jet, W_fuel_jet, LD_cruise_jet)
    print(M_empty_jet, x_cg, Fus_len)

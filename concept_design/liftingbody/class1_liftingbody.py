...
# THIS SECTION IS USED FOR JET AIRCRAFT; FOR TURBOPROP AIRCRAFT, SCROLL DOWN
    ...
    print(W_empty_jet, f_used_fuel_jet)
    ...
    return MTOW_jet, OEW_jet, W_fuel_jet, C_D_0_jet, f_cruise_start_jet, f_cruise_end_jet, LD_cruise_jet
...
# THIS SECTION IS USED FOR TURBOPROP AIRCRAFT
    ...
    print(W_empty_tbp, f_used_fuel_tbp)
    # Formula for the maximum take-off weight
    ...
    return MTOW_tbp, OEW_tbp, W_fuel_tbp, C_D_0_tbp, f_cruise_start_tbp, f_cruise_end_tbp, LD_cruise_tbp

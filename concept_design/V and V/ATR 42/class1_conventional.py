...
# THIS SECTION IS USED FOR JET AIRCRAFT; FOR TURBOPROP AIRCRAFT, SCROLL DOWN
    ...
    # Determine the maximum L/D for jets
        ...
        return MTOW_jet, OEW_jet, W_fuel_jet, C_D_0, f_cruise_start_jet, f_cruise_end_jet, LD_cruise_jet, LD_loiter_jet
...
# THIS SECTION IS USED FOR TURBOPROP AIRCRAFT
    ...
    # Determine the maximum L/D for a turboprop
        ...
        return MTOW_tbp, OEW_tbp, W_fuel_tbp, C_D_0, f_cruise_start_tbp, f_cruise_end_tbp, LD_cruise_tbp, LD_loiter_tbp
#RETARD
